  ...
  return (
    <MantineProvider theme={theme}>
      ...
      >
        <AppShell.Header className="rounded-b-md drop-shadow-lg">
          <Group h="100%" px="md">
            ...
            <Group justify="space-between" style={{ flex: 1 }}>
              ...
              <Group>
                <Button radius={20} onClick={() => navigate("/diagnose")}>
                  Diagnose
                </Button>
              </Group>
            </Group>
        ...
        <AppShell.Main className="bg-[#FBFBFB] h-screen" pb={"xl"}>
          <Outlet />
        </AppShell.Main>
        <AppShell.Footer>
            ...
            <div className="flex justify-between items-center md:flex-row flex-col p-8">
              ...
              <Group gap="xs" justify="flex-end" wrap="nowrap">
                <ActionIcon size="lg" variant="subtle" radius="xl">
                  <FeatherIcons icon="twitter" className="text-secondary" />
                </ActionIcon>
                <ActionIcon size="lg" variant="subtle" className="" radius="xl">
                  <FeatherIcons icon="instagram" className="text-secondary" />
                </ActionIcon>
                <ActionIcon size="lg" variant="subtle" radius="xl">
                  <FeatherIcons icon="facebook" className="text-secondary" />
                </ActionIcon>
              </Group>
            </div>
            {/* <ActionIcon
